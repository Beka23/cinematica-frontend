...
function LikesDislikes({
    ...
    function handleLikeMovie() {
        ...
        if (currentUser) {
            ...
            alert.show("Like this movie? Sign in to make your opinion count.")
        }
    }
    ...
    function handleDislikeMovie() {
        if (currentUser) {
            ...
            alert.show("Dislike this movie? Sign in to make your opinion count.")
        }
    }
    ...
    return (
        <div>
            <button onClick={handleLikeMovie} className="button">{movie.liked === false ? <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
                ...
                </svg>}{movie.likes}</button>

            <button onClick={handleDislikeMovie} className="button">{movie.disliked === false ? <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
            ...
            </svg> : <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-down-fill" viewBox="0 0 16 16">
